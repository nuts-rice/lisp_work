#lang br/quicklang
;Return value for macro is syntax template for rewritten code
(define-macro (bf-module-begin PARSE-TREE)
  #`(#%module-begin
      PARSE-TREE))
(provide (rename-out [bf-module-begin #%module-begin]))
;for some reason ... stands in as *. Think of SQL operator *. Zero or more
;function void discards input arguments
